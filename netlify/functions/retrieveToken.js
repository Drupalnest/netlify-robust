...
exports.handler = function(event, context, callback) {
  const command = 'node ./token/node/getTokenWithServiceAccount/getTokenWithServiceAccount -v --keyfile ./token/node/getTokenWithServiceAccount/apt-subset-398000-ff6b648af86a.json';
