                  ...
                  <div className="page__content col-md">
                    ...
                    >
                      ...
                      <div className="form-actions js-form-wrapper form-wrapper">
                        <button className="all-buttons-color text-white js-form-submit-modal-init button button--primary js-form-submit form-submit btn btn-md">
                          Update Member
                        </button>

                        <Link
                          to={`/${team}/members`}
                          className="btn js-form-submit btn btn-md btn-outline-primary"
                        >
                          Cancel
                        </Link>
                      </div>
